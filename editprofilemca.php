		...
		<div class="row">
            ...
            <div class="col-md-6">
			  ...
			  <!--Gradutaion Details UG Form-->
					...
					<form role="form" action="php/enterdetailsmca.php" method="post" enctype="multipart/form-data">
				<!--	<form role="form"> -->
						<div class="box-body">
						
							<div class="form-group">
								<label for="bcacollege">UG College</label>
								<input value="<?php 
								get("mca","bcacollege");
								?>"  name="bcacollege" type="text" class="form-control" id="bcacollege" placeholder="Enter College Name">
							</div>
							
							
					
							<div class="form-group">
									<label for="bcapercent">UG Percentage</label>
										<div>
																<input value="<?php 
										get("mca","finalcgpa");
										?>" name="bcapercent" type="number" min="0.0" max="100.0" class="form-control" id="bcapercent" placeholder="Enter Percentage" step="0.1">
										</div>
									...
									<div class="form-group">
							  <label for="bcayop">Year of Passing</label>
							  <div>
							  <select name="bcayop" class="form-control">
							...
							<div class="form-group">
									<label for="bs1gpa">Semester 1 GPA</label>
										<div>
											<input value="<?php 
					get("mca","bs1gpa");
					?>" id="bs1gpa" name="bs1gpa" type="number" min="0.0" max="10.0" class="form-control" id="sgpa1" placeholder="Enter GPA" step="0.1">
										</div>
							...
							<div class="form-group">
									<label for="s2gpa">Semester 2 GPA</label>
										<div>
											<input value="<?php 
					get("mca","bs2gpa");
					?>" id="bs2gpa" name="bs2gpa" type="number" min="0.0" max="10.0" class="form-control"  placeholder="Enter GPA" step="0.1">
										</div>
					...
					?>" id="bs5gpa" name="bs5gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
							...
							<div class="form-group">
									<label for="bs6gpa">Semester 6 GPA</label>
										<div>
											<input value="<?php 
					get("mca","bs6gpa");
					...
					<!-- Gradutaion Details UG Form Ends-->
           ...
           <div class="col-md-6">
				...
				<!--	<form role="form"> -->
						<div class="box-body">
							...
							<div class="form-group">
									<label for="mcapercent">PG Percentage</label>
										<div>
																										<input value="<?php 
										get("mca","finalcgpa");
										?>" name="mcapercent" type="number" min="0.0" max="100.0" class="form-control" id="mcapercent" placeholder="Enter Percentage" step="0.1">
										</div>
									...
									<div class="form-group">
							  <label for="mcayop">Year of Passing</label>
							  <div>
							  <select name="mcayop" class="form-control">
								<option selected value="<?php 
					get("mca","mcayop");
					?>"><?php 
					get("mca","mcayop");
							...
							<div class="form-group">
									<label for="ms1gpa">Semester 1 GPA</label>
										<div>
											<input value="<?php 
					get("mca","ms1gpa");
					?>" id="ms1gpas" name="ms1gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
							...
							<div class="form-group">
									<label for="ms2gpa">Semester 2 GPA</label>
										<div>
											<input value="<?php 
					get("mca","ms2gpa");
					?>" id="ms2gpas" name="ms2gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
					...
					?>" name="s4backlog" type="number" min="0" max="15.0" class="form-control" id="s4backlog" placeholder="Enter Number" step="1">
							...
							<div class="form-group">
									<label for="ms5gpa">Semester 5 GPA</label>
										<div>
											<input value="<?php 
					get("mca","ms5gpa");
					?>" id="ms5gpa" name="ms5gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
					...
					?>" name="s5backlog" type="number" min="0" max="15.0" class="form-control" id="s5backlog" placeholder="Enter Number" step="1">
							...
							<div class="form-group">
									<label for="ms6gpa">Semester 6 GPA</label>
										<div>
											<input value="<?php 
					get("mca","ms6gpa");
					?>" id="ms6gpa" name="ms6gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
					...
					?>" id="standingbacklogs" name="standingbacklogs" type="number" min="0" max="50" class="form-control" placeholder="Enter Current Standing Arriers" step="1">
							...
							<div class="form-group">
									...
									singleradio("mca","allclearfirstchance");
									?>>
										  Yes
										</label>
										<label>&nbsp </label>
									...
									marriedradio("mca","allclearfirstchance");
									?>>
										  No
										</label>
									</div>
					...
					<!-- Gradutaion Details MCA Form Ends-->

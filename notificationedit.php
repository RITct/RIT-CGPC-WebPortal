      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
         ...
         <ul class="sidebar-menu">
            ...
            <li  class="active"><a href="notificationedit.php"><i class="fa fa-bullhorn"></i> <span>Notification</span></a>
			</li>
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-md-12"  id="accordion">
				...
				<div class="box-body">
				<form method="post" action="php/notificationedit.php" class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Last Date</label>
                        <div class="col-sm-10">
                          <input name="ld" type="date" class="form-control" id="inputName" placeholder="dd-mm-yyyy">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Description</label>
                        <div class="col-sm-10">
                          <textarea name="desc" class="form-control" id="inputExperience" placeholder="Description"></textarea>
                        </div>
                      </div>
					  <div class="form-group">
                        ...
                        <div class="col-sm-10 checkbox">
                          <label>
                          <input value="off" name="btech" type="checkbox">
                          B.Tech
                        </label>
						<label></label>
						<label>
                          <input name="mtech" type="checkbox">
                          M.Tech
                        </label>
						<label></label>
						<label>
                          <input name="mca" type= "checkbox">
                          MCA
                        </label>
						<label></label>
						<label>
                          <input name="barc" type="checkbox">
                          B.Arch
                        </label>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-10 checkbox">
                          <label>
                          <input name="cse" type="checkbox">
                          CSE
                        </label>
						<label></label>
						<label>
                          <input name="ece" type="checkbox">
                          ECE
                        </label>
						<label></label>
						<label>
                          <input name="me" type="checkbox">
                          ME
                        </label>
						<label></label>
						<label>
                          <input name="ce" type="checkbox">
                          CE
                        </label>
						<label></label>
						<label>
                          <input name="eee" type="checkbox">
                          EEE
                        </label>
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input name="StandingArriers" type="number" min="0" max="50" step="1" class="form-control" placeholder="Standing Arriers">
                        </div>
                      </div>
					  <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">Min CGPA</label>
                        <div class="col-sm-10">
                           <input name="CGPA" type="number" min="0" max="10" step="0.1" class="form-control" placeholder="CGPA">
                        </div>
                      </div>
					  
					  <div class="form-group">
                        <label for="inputSkills" class="col-sm-2 control-label">Annual Package</label>
                        <div class="col-sm-10">
                           <input name="Package" type="number" min="0" max="100" step="0.01" class="form-control" placeholder="Annual Package">
                        </div>
                      </div>
              ...
              <div class="box box-widget">
                <div class='box-header with-border'>
                  <div class='user-block'>
                    ...
                    <span class='description'>Posted on 7:30 PM Today</span>
                  </div><!-- /.user-block -->
              <div class='box-tools'>

          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="aptitudeedit.php"><i class="fa fa-pencil"></i> Aptitude</a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
		  ...
		  <div class="col-md-12"  id="accordion">
				...
				<div class="box-body">
				<form action="php/aptitudeedit.php" method="post" class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Test Name</label>
                        <div class="col-sm-10">
                          <input name="testname" type="text" class="form-control" id="inputEmail" placeholder="Test Name">
                        </div>
                      </div>
                      <!-- Date dd/mm/yyyy -->
						<div class="form-group">
                        <label for="inputdate" class="col-sm-2 control-label">Test Date</label>
                        <div class="col-sm-10">
				  ...
				  <div class="form-group">
							...
							<label class="col-sm-2 control-label">Scored Mark</label>
							 <div class="col-sm-4">
								<input name="marks" type="number" class="form-control" id="inputname" placeholder="Mark">
							</div>
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Aptitude Result</h3>
                </div><!-- /.box-header -->
                <div class="box-body">

		...
		<div class="row">
            ...
            <div class="col-md-6">
			  ...
			  <!--Gradutaion Details BARCH Form-->
					...
					<form role="form" action="php/enterdetailsbarch.php" method="post" enctype="multipart/form-data">
				<!--	<form role="form"> -->
						<div class="box-body">
						
							<div class="form-group">
								<label for="barchcollege">B Arch College</label>
								<input value="<?php 
								get("barch","barchcollege");
								?>"  name="barchcollege" type="text" class="form-control" id="barchcollege" placeholder="Enter College Name">
							</div>
							
							
					
							<div class="form-group">
									<label for="barchpercent">B Arch Percentage</label>
										<div>
																<input value="<?php 
										get("barch","barchpercent");
										?>" name="barchpercent" type="number" min="0.0" max="100.0" class="form-control" id="barchpercent" placeholder="Enter Percentage" step="0.1">
										</div>
									...
									<div class="form-group">
							  <label for="barchyop">Year of Passing</label>
							  <div>
							  <select name="barchyop" class="form-control">
							...
							<div class="form-group">
									<label for="s1gpa">Semester 1 GPA</label>
										<div>
											<input value="<?php 
					get("barch","s1gpa");
					?>" name="s1gpa" type="number" min="0.0" max="10.0" class="form-control" id="ms1gpa" placeholder="Enter GPA" step="0.1">
										</div>
							...
							<div class="form-group">
									<label for="s2gpa">Semester 2 GPA</label>
										<div>
											<input value="<?php 
					get("barch","s2gpa");
					?>" id="s2gpa" name="s2gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
							...
							<div class="form-group">
									<label for="s4gpa">Semester 4 GPA</label>
										<div>
											<input value="<?php 
					get("barch","s4gpa");
					?>" id="s4gpa" name="s4gpa" type="number" min="0.0" max="10.0" class="form-control"  placeholder="Enter GPA" step="0.1">
										</div>
					...
					?>" id="s8gpa" name="s8gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
							...
							<div class="form-group">
									<label for="s9gpa">Semester 9 GPA</label>
										<div>
											<input value="<?php 
					get("barch","s9gpa");
					?>" id="s9gpa" name="s9gpa" type="number" min="0.0" max="10.0" class="form-control" id="s7gpa" placeholder="Enter GPA" step="0.1">
										</div>
							...
							<div class="form-group">
									<label for="s10gpa">Semester 10 GPA</label>
										<div>
											<input value="<?php 
					get("barch","s10gpa");
					?>" id="s10gpa" name="s10gpa" type="number" min="0.0" max="10.0" class="form-control" placeholder="Enter GPA" step="0.1">
										</div>
					...
					<!-- Gradutaion Details BARCH Form Ends-->
           ...
           <div class="col-md-6">
				...
				<!--	<form role="form"> -->
					...
					?>" name="s8backlog" type="number" min="0" max="15.0" class="form-control" id="s8backlog" placeholder="Enter Number" step="1">
							...
							<div class="form-group">
									<label for="s9backlog">Semester 9 Backlog</label>
										<div>
											<input value="<?php 
					get("barch","s9backlog");
					?>" name="s9backlog" type="number" min="0" max="15.0" class="form-control" id="s9backlog" placeholder="Enter Number" step="1">
										</div>
							...
							<div class="form-group">
									<label for="s10backlog">Semester 10 Backlog</label>
										<div>
											<input value="<?php 
					get("barch","s10backlog");
					?>" name="s10backlog" type="number" min="0" max="15.0" class="form-control" id="s10backlog" placeholder="Enter Number" step="1">
										</div>
					...
					?>" id="standingbacklogs" name="standingbacklogs" type="number" min="0" max="50" class="form-control" placeholder="Enter Current Standing Arriers" step="1">
							...
							<div class="form-group">
									...
									singleradio("barch","allclearfirstchance");
									?>>
										  Yes
										</label>
										<label>&nbsp </label>
									...
									marriedradio("barch","allclearfirstchance");
									?>>
										  No
										</label>
									</div>
